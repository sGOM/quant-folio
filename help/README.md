...
> 매매 엔진)** 를 깊게 설명한다.
>
> **FastAPI도 처음이고 이 코드도 처음이라면** → 먼저
> [`00-하루만에-이해하기.md`](00-하루만에-이해하기.md) 를 위에서 아래로 따라가라.
> 하루치 실습 코스로 "이 앱이 뭘 하고 코드가 어디서 도는지"의 지도를 먼저 만든 뒤,
> 아래 01~08 문서로 깊이 들어오면 훨씬 잘 붙는다.
...
| 순서 | 문서 | 무엇을 얻는가 |
|------|------|----------------|
| 0 | [`00-하루만에-이해하기.md`](00-하루만에-이해하기.md) | (완전 입문자용) 하루치 실습 코스로 앱·코드의 지도 만들기 |
